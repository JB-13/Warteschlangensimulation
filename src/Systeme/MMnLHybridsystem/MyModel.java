...
import Events.HybrideEvents.ArrivalEventMMnl;
import Events.HybrideEvents.DurationEventMMnl;
...
public class MyModel {
    ...
    public void run() {
        ...
        new DurationEventMMnl(0.0, this.clock, this.service, 0, this.queue, this.warteProba, this.genB);
        this.queue.insertEvent(new ArrivalEventMMnl(this.genA.draw(), this.clock, this.queue, this.genA, this.genB, this.warteProba, this.service, this.maxqueuelength));
    ...
    public double getPBlock() {
        return this.warteProba.PBlock();
    }
